...
export function ReportView({
  ...
  return (
    <div className="space-y-6">
      ...
      <StepCard step={3} title="캐리 트레이드" score={step3.score}>
      ...
      <StepCard step={4} title="환율·금·유가" score={step4.score}>
      ...
      <StepCard step={5} title="규모별·성격별 자금 도착" score={step5.score}>
      ...
      <StepCard step={6} title="자본의 최종 목적지(섹터, 사후 확인용)" score={step6.score}>
        <Field label="충족 섹터" value={step6.qualifying.length > 0 ? step6.qualifying.join(", ") : "없음"} />
      </StepCard>

      <StepCard step={7} title="심리 필터(합산 제외, 포지션 크기 조절용)">
