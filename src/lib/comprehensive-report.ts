...
단, "좋지 않은 환경이다"처럼 상태 설명만으로 끝내지 말고, 그래서 지금 어떤 대응을 하는 게 좋을지
구체적인 전략까지 한 문장 더 덧붙여 마무리해라(예: 결론이 "현금비중늘리기"면 "방어적으로 현금 비중을
늘리고 신규 매수는 보류하는 전략이 필요하다", "매수"면 "권장 매수 비중 내에서 분할 매수를 고려할 만하다",
"지켜보기"면 "신규 매수보다는 관망하며 다음 지표 변화를 기다리는 게 낫다" 같은 식).
