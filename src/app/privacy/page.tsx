    ...
    <div className={siteStyles.page}>
      ...
      <div className={siteStyles.wrap} style={{ paddingTop: "2rem", paddingBottom: "3rem" }}>
        <article className={styles.prose}>
          ...
          <h2>회원가입·로그인 없음</h2>
          <p>
            이 사이트는 회원가입·로그인 기능이 없습니다. 이름, 이메일 등 개인을 식별할 수 있는
            정보를 입력받거나 저장하지 않습니다.
          </p>
          ...
          <h2>서버 로그</h2>
          <p>
            호스팅사(Vercel)가 서비스 운영을 위해 표준적으로 남기는 접속 로그(IP, 요청 시각,
            요청 경로 등)가 있을 수 있으며, 이는 Vercel의 자체 정책에 따라 처리됩니다. 이 로그를
            운영자가 별도로 수집·분석하지 않습니다.
          </p>

          <h2>외부 링크</h2>
          <p>
            각 지표의 &ldquo;바로가기&rdquo; 링크는 FRED·Yahoo Finance 등 외부 사이트로 연결됩니다. 외부
            사이트에서의 개인정보 처리는 해당 사이트의 정책을 따릅니다.
          </p>
