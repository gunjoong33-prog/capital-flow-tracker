        ...
        <article className={styles.prose}>
          ...
          <p className={styles.sentences}>
            <span>
              ...
              <strong>투자 자문이나 투자 권유가 아닙니다.</strong>
            </span>
            <span>특정 종목이나 상품을 매수·매도하라는 권유가 아니며, 어떤 형태의 금융 자문업도 등록되어 있지 않습니다.</span>
          </p>

          <h2>2. 데이터의 정확성</h2>
          <p className={styles.sentences}>
            <span>FRED, Yahoo Finance, CFTC, DART, KRX 등 공개 소스에서 데이터를 가져오지만, 원본 소스의 지연·오류·중단으로 표시값이 틀리거나 늦게 갱신될 수 있습니다.</span>
            <span>데이터가 정확하거나 최신임을 보장하지 않습니다.</span>
          </p>

          <h2>3. 책임의 한계</h2>
          <p className={styles.sentences}>
            <span>이 사이트의 정보를 이용해 내린 투자 판단과 그로 인한 손익은 전적으로 이용자 본인의 책임입니다.</span>
            <span>운영자는 이 사이트의 정보를 근거로 발생한 어떠한 손해에 대해서도 법적 책임을 지지 않습니다.</span>
          </p>
