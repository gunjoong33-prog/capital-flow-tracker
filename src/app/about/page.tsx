      ...
      <div className={siteStyles.wrap} style={{ paddingTop: "2rem", paddingBottom: "3rem" }}>
        <article className={styles.prose}>
          ...
          <p className={styles.sentences}>
            ...
            <span>2026년 7월 27일부터 매일 자동으로 갱신됩니다.</span>
          </p>
          <h2>운영 형태</h2>
          <p className={styles.sentences}>
            <span>법인이나 사업자가 아닌 개인이 만들고 무료로 운영하는 사이드 프로젝트입니다.</span>
            <span>별도 고객센터나 회사 조직은 없습니다.</span>
            <span>
              문의·오류 제보는{" "}
          ...
          <p className={styles.sentences}>
            <span>
              ...
              유동성 분석 틀을 참고해 만들었습니다.
            </span>
            <span>
              각 단계의 가중치는 학술적으로 검증된 공식이 아니라, 이 프레임워크를 참고한 경험적
              추정값입니다 — 각 지표의 상세 화면에 실제 가중치와 계산식을 그대로 노출합니다.
            </span>
          </p>
          <h2>참고 리서치 원문</h2>
          <p>
          ...
          <h2>운영 기간이 짧다는 점</h2>
          <p className={styles.sentences}>
            <span>2026년 7월 27일 이후로 아직 운영 기간이 길지 않아, 신호의 장기 정확도는 검증되지 않았습니다.</span>
            <span>참고 자료로만 활용하시고, 이 사이트의 신호만으로 투자 결정을 내리지 마세요.</span>
            <span>
              자세한 면책 조항은 <a href="/terms">이용약관</a>을 참고하세요.
            </span>
          </p>
        </article>
      </div>
